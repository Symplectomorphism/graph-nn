...
An autoregressive model assumes that the current value of a time series is a
...
TCN is a type of neural network architecture designed for sequence modeling
