...
\hypersetup{
    ...
    pdftitle={Stock Market Telepathy: Graph Neural Networks Predicting the Secret Conversations between MINT and G7 Countries},    % title
    pdfauthor={Nurbanu Bursa}, % author
